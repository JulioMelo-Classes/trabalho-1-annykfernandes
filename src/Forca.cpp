...
Level lvl = Level::EASY; //<! dificuldade do jogo
...
void Forca::setLevel(int d)
{
    if(d == 1)
    {
        ...
        std::cout<<"Escolheu fácil izi pizi lemon squizi"<<std::endl;
    }
    else if(d == 2)
    {
        Level lvl = Level::MEDIUM;
        std::cout<<"Escolheu medio"<<std::endl;
    }
    else if(d == 3)
    {
        Level lvl = Level::HARD;
        std::cout<<"Eita, escolheu dificil"<<std::endl;
    }
}
